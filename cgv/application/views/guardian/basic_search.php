          ...
          <div class="card">
            <div class="header">
              <h2>
                ...
                ?>
                <i class="material-icons"></i><b><?php echo $view['fname'].' '.$view['middle'].' '.$view['lname']; ?></b>, Grades as of S.Y. <?php echo $school_year; ?>
                <?php } ?>
              </h2>
            </div>
            <div class="body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                  ...
                  <tbody>
                  	<?php 
                      foreach($basic_search as $view)extract($view);{ 
                    ?>
                  	<tr>
