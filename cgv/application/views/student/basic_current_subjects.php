            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <i class="material-icons">assignment</i> <b>Current Subjects Taken. S.Y <?php echo $this->session->userdata('curr_sy'); ?></b>
                                <a class="pull-right" href="<?php echo base_url(); ?>student/print_current_grade/<?php echo $stud_id; ?>" target="__blank">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php 
                                            foreach($basic_current_subjects as $view){ 
                                        ?>
                                        <?php 
                                            if ($view['bin'] == 1) {
                                                $remarks = '<b>DROPPED </b>';
