...
<body class="login-page login-design">
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" action="<?php echo base_url(); ?>login/check_teacher_password">
                    ...
                    <div class="media">
                        <div class="media-left">
                            <a href="javascript:void(0);">
                                <img class="media-object" src="<?php echo base_url() ?>webroot/images/<?php echo $teacher_image; ?>" width="64" height="64">
                            </a>
                        </div>
                        <div class="media-body">
                            <h4 class="media-heading"><?php echo $teacher_name; ?></h4><br><i><b><i>Teacher</i></b></i>
