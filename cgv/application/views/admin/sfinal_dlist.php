...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="legal">
            <div class="copyright">
                &copy; <?php echo date("Y"); ?> <a href="javascript:void(0);"><b>WEBOGS</b> </a> All Rights Reserved.
            </div>
        </div>
        <!-- #Footer -->
    </aside>
...
<section class="content">
    <div class="container-fluid">
        <!-- <div class="card">
            ...
            <center>
                <div class="container-fluid">
                    <form method="POST" action="<?php echo base_url(); ?>admin/search_sfinal_dlist">
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <button id="search_sfinal" type="submit" class="btn btn-primary btn-lg m-l-15 waves-effect"><i class="material-icons">search</i> SEARCH</button>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        <?php foreach($sfinal as $row){ 
                            $sy = $row['sy'];
                        } ?>
                        <h2>
                            <i class="material-icons">description</i> Semi-Final's Dean's List for S.Y. <b><?php echo $this->session->userdata('curr_sy');?> <?php echo $this->session->userdata('curr_sem');?></b>. 
                            <a class="pull-right" href="<?php echo base_url().'admin/print_sfinal_dlist/'?>" target="__blank">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="thumbnail text-center">
                                        <div class="caption">
                                            ...
                                            <p class="text-center">
                                                <a href="javascript:void(0);" class="btn btn-primary waves-effect" role="button">AVERAGE: <?php echo substr($final_sfinal_grade, 0, 4); ?></a><br/>
                                                <b></b>
                                            </p>
                                        </div>
                                    </div>
