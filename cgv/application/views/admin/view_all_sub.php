            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                <i class="material-icons">assignment</i> <b>The following are list of all opened subjects.</b>
                                <a class="pull-right" href="<?php echo base_url(); ?>admin/print_all_subjects" target="__blank">
