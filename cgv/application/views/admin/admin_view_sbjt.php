            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                <i class="material-icons">assignment</i> <b>The following are list of all subjects.</b><!-- 
                                <a class="pull-right" href="<?php echo base_url(); ?>admin/print_all_subjects">
                                    ...
                                    <tbody>
                                        <?php foreach($view_sbjt as $view){ ?>
                                          <tr>
                                              ...
                                              <td><?php echo $view['pre_requisite'] ?></td>
                                              <td class="text-center">
                                                  <a href='<?php echo base_url(); ?>admin/admin_update_sbjt/<?php echo $view['sbjt_id']; ?>#' data-placement="top" title="Update Subject" data-toggle="tooltip">
                                                          <button type="button" class="btn btn-warning btn-xs"><i class="material-icons">create</i></button> </a>
                                                  <a href='<?php echo base_url(); ?>admin/delete_sbjt/<?php echo $view['sbjt_id']; ?>' data-placement="top" title="Delete Subject" data-toggle="tooltip">
