                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                ?> 
                                <i class="material-icons"></i><b><?php echo $stud_name ?></b> Subjects as of <b>S.Y. <?php echo $this->session->userdata('curr_sy');; ?></b>
                                <button id="sendButton" onclick="send_Msg(<?php echo $stud_info['stud_id']; ?>)" type="button" class="btn btn-info pull-right" data-toggle="modal" data-target="#defaultModal<?php echo $stud_id; ?>"><i class="material-icons">email</i> <span> Send Grade To Parent</span></button>
                                <a class="pull-right" href="<?php echo base_url(); ?>admin/print_basic_student_grade/<?php echo $stud_id;?>/<?php echo $student_name;?>/<?php echo $year_level;?>" target="__blank">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php 
                                            //$total_units = 0;
                                            foreach($view_all_basic_subjects as $view){   
                                        ?>
                                        <?php 
                                            if ($view['bin'] == 1) {
                                                $remarks = '<b>DROPPED </b>';
          ...
          <div class="modal-body">
            <div class="col-md-12">
              ...
              <!-- <div class="col-md-6">
                ...
                <br/>
                <?php foreach ($parentNumber as $num) { ?>
                <label>Send to:</label>
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                  <div class="form-line">
                    <textarea  cols="8" rows="12" name="mess" required="" id="txt_msg" class="form-control no-resize" readonly></textarea>
                  </div>
                </div>
