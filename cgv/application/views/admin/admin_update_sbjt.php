                        ...
                        <div class="body">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <?php } ?>
                                    <div class="col-md-12">
                                    <?php foreach($view_sbjt as $view){ ?>
                                        <form class="form-horizontal" action="<?php echo base_url(); ?>admin/update_sbjt_validation/<?php echo $view['sbjt_id']; ?>" method="post" accept-charset="utf-8">
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="">
                                                            <div class="col-md-2">
                                                                ...
                                                                <div class="form-line">
                                                                    <input type="text" class="form-control" id="sub_name" placeholder="Course Code" name="sub_name" value="<?php echo $view['sub_name'] ?>" required="">
                                                                </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="form-line">
                                                                    <input type="text" class="form-control" id="course_description" placeholder="Description" name="course_description" value="<?php echo $view['course_description'] ?>" required="">
                                                                </div>
                                                                <span class="help-block"><small>Example: IT101</small></span>
                                                            </div>
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="form-line">
                                                                    <input type="text" class="form-control" id="units" placeholder="Units" name="units" value="<?php echo $view['units'] ?>" required="" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));">
                                                                </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="form-line">
                                                                    <input type="text" class="form-control" id="pre_requisite" placeholder="Pre-Requisite" name="pre_requisite" value="<?php echo $view['pre_requisite'] ?>">
                                                                </div>
                                                                <span class="help-block"><small>Example: IT101</small></span>
                                                            </div>
                                                        </div>
