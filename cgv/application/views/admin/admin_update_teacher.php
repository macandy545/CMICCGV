                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="card">
                            <div class="header modal-col-cyan">
                                <h2>
                                    <i class="material-icons">create</i> Updating Teacher page. Make sure you have fill all the information below.
                                </h2>
                            </div>
                            <div class="body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="list-group">
                                            <li class="list-group-item">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <?php foreach($view_teacher as $view){ ?>
                                                        <form class="form-horizontal" action="<?php echo base_url(); ?>admin/update_teacher_validation/<?php echo $view['teacher_id']; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                                            <div class="row">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="form-group">
                                                                                    <div class="thumb-xl member-thumb m-b-10 center-block pic">
                                                                                        <img src="<?php echo base_url().'webroot/images/'.$view['teacher_image'] ?>" class="img-circle img-thumbnail" alt="profile-image" id="imgadmin">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="form-group">
                                                                                      <label for="teacher_image" class="control-label col-lg-2"><b>Profile Image</b></label>
                                                                                      <div class="col-lg-8">
                                                                                        <input class="form-control btn btn-success" onchange="previewFile();" id="img2" name="teacher_image"  type="file" />
                                                                                        <input type="hidden" id="_teacherimagename" name="_teacherimagename" value="<?php echo $view['teacher_image'] ?>">
                                                                                      </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="panel-body">
                                                                        <div class="">
                                                                            <div class="col-md-5">
                                                                                ...
                                                                                <input type="text" class="form-control" id="lname" placeholder="Teacher's Lastname" name="lname" required="" value="<?php echo $view['lname']; ?>">
                                                                                <span class="help-block"><small>Teacher's Last Name</small></span>
                                                                            </div>
                                                                            <div class="col-md-5">
                                                                                <label for="firstname">First Name*</label>
                                                                                <input type="text" class="form-control" id="fname" placeholder="Teacher's Firstname" name="fname" required="" value="<?php echo $view['fname']; ?>">
                                                                                <span class="help-block"><small>Teacher's First Name</small></span>
                                                                            </div>
                                                                            <div class="col-md-2">
                                                                                <div class="">
                                                                                    <label>Middle*</label>
                                                                        ...
                                                                        <div class="">
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <input type="text" maxlength="2" class="form-control" id="age" placeholder="age" name="age" value="<?php echo $view['age']; ?>" required="" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <input type="text" class="form-control" id="email_address" placeholder="Email_Address" name="email_address" value="<?php echo $view['email_address']; ?>" required="">
                                                                                <span class="help-block"><small>Ex. abc@gmail.com</small></span>
                                                                            </div>
                                                                             <div class="col-md-6">
                                                            ...
                                                            <div class="form-group text-center">
                                                                <div class="col-md-12 m-b-20">
                                                                   <button type="submit" class="btn btn-success"><i class="material-icons">mode_edit</i> Update Teacher</button>
