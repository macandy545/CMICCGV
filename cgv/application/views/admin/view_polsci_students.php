                ...
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>admin/current_basic_students"><i class="material-icons col-red">group</i> 
                                  <span>Basic Students</span>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                <i class="material-icons">assignment</i> The following are the list of <b>AB Pol-Sci</b> Students for S.Y. <b><?php echo $this->session->userdata('curr_sy');?> <?php echo $this->session->userdata('curr_sem');?></b>. 
                                <a class="pull-right" href="<?php echo base_url(); ?>admin/print_all_polsci_student" target="__blank">
                                    <button type="button" class="btn btn-info waves-effect">
                                        <i class="material-icons">print</i>
                                        <span>PRINT ALL AB Pol-Sci</span>
                                    </button>
                                </a> 
                        </div>
                        <div class="body">
