        ...
        <div class="container-fluid">
          <button onclick="history.back()" class="btn bg-cyan btn-circle waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Go Back"><i class="material-icons">arrow_back</i></button> Go Back To Previous Page
            <div class="pull-right">
              <a href="<?php echo base_url(); ?>admin/add_parent">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                              <i class="material-icons">assignment</i> The following are list of parents.
                            </h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    <thead>
                                        ...
                                        <?php } ?>
                                    <tbody>
                                        <?php foreach($view_parents as $view){ ?>
                                        <tr>
                                            <td>
                                              <div class="btn-group">
                                                <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                      <?php echo $view['parent_id']; ?> <span class="caret"></span>
                                                </button>
                                                <ul class="dropdown-menu">
                                                      <li><a href="javascript:void(0);"><?php echo $view['parent_pass']; ?></a></li>
                                                </ul>
                                              </div>
                                            </td>
                                            <td><center><span class="table_image"><img src="<?php echo base_url(); ?>webroot/images/<?php echo $view['parent_image']; ?>" class="img-circle img-thumbnail" alt="profile-image" id="img"></span></center></td>
                                            <td><?php echo $view['lname'].', '.$view['fname'].' '.$view['middle']; ?></td>
                                            <td><?php echo $view['contact_num']; ?></td>
                                            <td><?php echo $view['address']; ?></td>
                                            <td class="text-center">
                                              <a href='<?php echo base_url(); ?>admin/update_parent/<?php echo $view['parent_id']; ?>#' data-placement="top" title="Update Student" data-toggle="tooltip">
                                              <button type="button" class="btn btn-warning btn-xs"><i class="material-icons">create</i></button>
                                              </a>
                                              <a href='<?php echo base_url(); ?>admin/delete_parent/<?php echo $view['parent_id']; ?>' data-placement="top" title="Delete Student" data-toggle="tooltip">
                                              <button type="button" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete this Parent?')"><i class="material-icons">delete_sweep</i>
                                              </button>
                                              </a>
