        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        <h2>
                            <i class="material-icons">email</i> Messages from Teachers.
                        </h2>
                    <br/>    
                    </div>
                    <div class="body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    <?php foreach($view_all_message as $msg){ extract($msg);
                                        $teacher_name = $fname.' '.$middle.' '.$lname;
                                    ?>
                                    <tr>
                                        <td><?php echo $teacher_name; ?></td>
                                        <td><?php echo $message; ?></td>
                                        <td class="text-center">
                                            <a href='<?php echo base_url(); ?>admin/mark_as_read/<?php echo $msg_id; ?>#'>
                                                <button type="button" class="form-control btn btn-info btn-xs"  title="MArk as Read"><i class="material-icons">done</i> Mark as Read</button>
                                            </a>
                                            
                                           <!--  <button type="button" class="form-control btn btn-danger btn-xs"  title="Delete Message"><i class="material-icons">delete_sweep</i> Delete</button> -->
                                        </td>
                                    </tr>
                                <?php } ?> 
                                </tbody>
