                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <?php foreach($view_subjects as $view){ ?>
                                        <form class="form-horizontal" action="<?php echo base_url(); ?>admin/update_subject_validation/<?php echo $view['sub_id']; ?>" method="post" accept-charset="utf-8">
                                            <div class="col-md-12">
                                                        ...
                                                        <div class="">
                                                            <div class="col-md-6">
                                                                <label>Subjects</label>
                                                                    <select class="form-control" name="sbjt_id">
                                                                            <option value="<?php echo $view['sbjt_id']; ?>"><?php echo $view['sub_name']; ?></option> 
                                                                        <?php foreach ($view_sbjt as $view1 ): ?>
                                                                            <option value="<?php echo $view1['sbjt_id']; ?>"><?php echo $view1['sub_name']; ?></option> 
                                                                        <?php endforeach ?>
                                                                    </select>
                                                        ...
                                                        <div class="">
                                                            <div class="col-md-12">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select size="8" multiple="multiple" class="form-control" name="schedule[]">
                                                                        <option value="<?php echo $view['schedule']; ?>"><?php echo $view['schedule']; ?></option>
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <input type="text" class="form-control" id="time_start" placeholder="Time Start" name="time_start" value="<?php echo $view['time_start']; ?>" required="">
                                                                    <span class="help-block"><small>Example: 4:00pm</small></span>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <label for="time_end">Time End </label>
                                                                    <input type="text" class="form-control" id="time_end" placeholder="Time End" name="time_end" value="<?php echo $view['time_end']; ?>" required="">
