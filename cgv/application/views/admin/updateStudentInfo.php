                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="list-group">
                                            <li class="list-group-item">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                    <?php foreach($view_basic_student as $view){ ?>
                                                        <form class="form-horizontal" action="<?php echo base_url(); ?>admin/update_basic_student_validation/<?php echo $view['stud_id']; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                                        <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="form-line">
                                                                              <?php foreach($get_name as $name){ ?>
                                                                                <input type="text" class="form-control filled-in select_teacher" id="selected"  value="<?php echo $name['fname'].' '.$name['middle'].' '.$name['lname']; ?>" required="" readonly="">  
                                                                    ...
                                                                    <div class="">
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <select class="form-control" name="year_level">
                                                                                <option value="<?php echo $view['year_level']; ?>"><?php echo $view['year_level']; ?></option>
