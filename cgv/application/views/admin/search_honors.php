...
<section class="content">
    <div class="container-fluid">
        <button onclick="history.back()" class="btn bg-cyan btn-circle waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Go Back"><i class="material-icons">arrow_back</i></button>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <h2>
                            <i class="material-icons">description</i> HONOR STUDENTS for S.Y. <b><?php echo $school_year;?></b> . 
                            <a class="pull-right" href="<?php echo base_url(); ?>admin/print_search_honor_student/<?php echo $school_year; ?>" target="__blank">
                    ...
                    <div id="" class="body">
                        <div class="row">
                            <?php foreach($search_honors as $view){ 
                                $no_of_subject = 0;
                                $final_grade = 0;
