            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <i class="material-icons">assignment</i> The following are list of subjects as of <b> <?php echo $this->session->userdata('curr_sy'); ?>.</b>
                        ...
                        <div class="body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <?php foreach($view_basic_subjects as $view){  extract($view); ?>
                                        <tr>
                                          ...
                                          <!-- <td><?php echo $semester; ?></td> -->
                                            <td class="text-center">
                                              ...
                                              <a href='<?php echo base_url(); ?>admin/students_of_this_subject/<?php echo $basic_subject_id; ?>/<?php echo $sub_name; ?>' data-placement="top" title="View Students" data-toggle="tooltip">
