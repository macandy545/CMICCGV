       ...
       <!--  <div class="card">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        <?php foreach($prelim as $row){ 
                            $sy = $row['sy'];
                        } ?>
                        <h2>
                            <i class="material-icons">description</i> Prelim's Dean's List for S.Y. <b><?php echo $this->session->userdata('curr_sy');?>, <?php echo $this->session->userdata('curr_sem');?></b> . 
                            <a class="pull-right" href="<?php echo base_url().'admin/print_prelim_dlist/'?>" target="__blank">
