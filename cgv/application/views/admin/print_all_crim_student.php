 ...
 <body>
    ...
    <div class="col-md-12">
        ...
        <h4>List of All BS Crim Students</h4>
        <p><?php echo $this->session->userdata('curr_sem'); ?>, <?php echo $this->session->userdata('curr_sy'); ?></p>
       </center>
        <!-- <center><h4>List Of All BS Criminology Student for S.Y. <?php echo $this->session->userdata('curr_sy');?> <?php echo $this->session->userdata('curr_sem');?></h4></center> -->
