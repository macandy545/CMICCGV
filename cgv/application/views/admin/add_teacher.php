                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        <div class="header modal-col-cyan">
                            <h2>
                                <i class="material-icons">assignment</i> Adding New Teacher. Fill up all informations needed below.
                            </h2>
                        </div>
                        <div class="body">
                            <div class="row">
                                <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form class="form-horizontal" action="<?php echo base_url(); ?>admin/teacher_validation" method="post" accept-charset="utf-8">
                                                    <div class="row">
                                                                ...
                                                                <div class="member-card">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-8 col-md-offset-2">                                   
                                                                             <label class=""><b>Profile Image</b></label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="form-group">
                                                                              <label class="control-label col-lg-2"><b>Profile Image</b></label>
                                                                              <div class="col-lg-8">
                                                                                <input class="form-control btn btn-success" id="teacher_img" name="teacher_image"  type="file" />
                                                                                <input type="hidden" id="_teacherimagename" name="_teacherimagename" value="user.png">
                                                                              </div>
                                                                        </div>
                                                                    </div>
                                                                   <!--  <div class="row">
                                                                        <div class="form-group">                                                  
                                                                              <div class="col-lg-8">
                                                                                <button class="form-control btn btn-success" type="button" id="select_image">
                                                                                    <span>Select Image</span>
                                                                                    <input  id="teacher_img" class="hidden" name="teacher_image"  type="file"/>
                                                                                </button>
                                                                                <input type="hidden" id="_teacherimagename" name="_teacherimagename" value="user.png">
                                                                                <script type="text/javascript">
                                                                                   document.querySelector('#select_image')
                                                                                        .addEventListener('click', function() {
                                                                                        document.querySelector('#teacher_img').click()
                                                                                    })
                                                                                </script>
                                                                              </div>
                                                                        </div>
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="">
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        ...
                                                                        <div class="form-line">
                                                                            <input type="text" class="form-control" id="fnmae" placeholder="firstname" name="fname" required="">
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        ...
                                                                        <span class="help-block"><small>Ex: A.</small></span>
                                                                    </div>
                                                                </div>
                                                                <div class="">
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="form-line">
                                                                            <input type="text" maxlength="2" class="form-control" id="age" placeholder="age" name="age" required="" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));">
                                                                        </div>
                                                    ...
                                                    <div class="form-group text-center">
                                                        <div class="col-md-12 m-b-20">
                                                            <button type="submit" class="btn btn-success"><i class="material-icons">person_add</i> Add Teacher</button>
