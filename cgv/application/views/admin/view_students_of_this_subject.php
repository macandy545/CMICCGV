            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?php echo base_url(); ?>admin/print_current_prelim_grades/<?php echo $basic_subject_id; ?>/<?php echo $sub_name; ?>" target="__blank"><i class="material-icons">print</i> Print Prelim Grades</a></li>
                            <li><a href="<?php echo base_url(); ?>admin/print_current_midterm_grades/<?php echo $basic_subject_id; ?>/<?php echo $sub_name; ?>" target="__blank"><i class="material-icons">print</i> Print Midterm Grades</a></li>
                            <li><a href="<?php echo base_url(); ?>admin/print_current_semi_final_grades/<?php echo $basic_subject_id; ?>/<?php echo $sub_name; ?>" target="__blank"><i class="material-icons">print</i> Print Semi-Final Grades</a></li>
                            <li><a href="<?php echo base_url(); ?>admin/print_current_final_grades/<?php echo $basic_subject_id; ?>/<?php echo $sub_name; ?>" target="__blank"><i class="material-icons">print</i> Print Final Grades</a></li>
                            <li><a href="<?php echo base_url().'admin/print_students_under_this_subject/'.$basic_subject_id.'/'.$sub_name; ?>" target="__blank"><i class="material-icons">print</i> Print All</a>
                            </li>
                        </ul>     -->
                        </h2>
                    <br/>    
                    ...
                    <div class="body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                <?php foreach($basic_grade as $view){ ?>
                                <?php 
                                    if ($view['bin'] == 1) {
                                        $rating = '<b>DROPPED </b>';
                                    }
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><b><?php echo ($view['fourth_grading'] == 0) ? '' : $view['fourth_grading']; ?></b></td>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-success btn-xs form-control"  data-toggle="modal" data-placement="top" data-target="#myModal<?php echo $view['stud_id']; ?>" title="Add/Update Student Grade"><i class="material-icons">create </i>Add Grade</button>
                                             <a href='<?php echo base_url(); ?>admin/delete_subjects_students/<?php echo $view['stud_id']; ?>/<?php echo $basic_subject_id?>/<?php echo $sub_name?>'>   
                                            ...
                                            <!-- <a href="<?php echo base_url(); ?>admin/print_single_student_grade_under_this_subject/<?php echo $view['basic_subject_id']; ?>/<?php echo $sub_name; ?>/<?php echo $view['stud_id']; ?>">
  ...
  <div class="modal fade" id="myModal<?php echo $view['stud_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <?php echo form_open("admin/update_basic_student_grade/".$view['stud_id']."/".$view['basic_subject_id']."/".$sub_name); ?>
                   ...
                   <div class="m-b-20 table-responsive">
                       <table id="datatable" class="table table-bordered table-hover js-basic-example dataTable">
                            ...
                            <tbody class="table-hovered">
                                    <?php foreach($view_basic_students as $student){ ?>
                                        <tr id="<?php echo $student['stud_id']; ?>">
                                            ...
                                            <td class="center">
                                                <a href='<?php echo base_url(); ?>admin/add_basic_student_to_subject_validation/<?php echo $student['stud_id']; ?>/<?php echo $basic_subject_id?>/<?php echo $sub_name?>'>
