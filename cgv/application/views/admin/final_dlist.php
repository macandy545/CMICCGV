            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        ...
                        <h2>
                            <i class="material-icons">description</i>Final's Dean's List as of  <b><b><?php echo $this->session->userdata('curr_sy');?> <?php echo $this->session->userdata('curr_sem');?></b>. 
                            <a class="pull-right" href="<?php echo base_url().'admin/print_final_dlist/'?>" target="__blank">
