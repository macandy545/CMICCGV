                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        <div class="header modal-col-cyan">
                            <h2>
                                <i class="material-icons">library_add</i> Opening a Subject for Basic Students.
                            </h2>
                        </div>
                        <div class="body">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <?php } ?>
                                    <?php echo form_open("admin/add_basic_subject_validation"); ?>
                                    <div class="row">
                                        <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="form-line">
                                                                    <input style="background-color:white;" type="text" class="form-control filled-in" name="sub_name" placeholder="Enter Subject Name" required="" >
                                                                </div><!-- 
                                                                <center>
                                                    ...
                                                    <div class="row">
                                                        <div class="">
                                                            <div class="col-md-6">
                                                                ...
                                                                <select size="7" multiple="multiple" class="form-control" name="sched[]">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <select class="form-control" name="from_year"  placeholder="from" required=""  >
                                                            ...
                                                            <div class="col-md-2">
                                                                <label>TO*</label>
                                                                <?php $data = range('2010', '2050'); ?>
                                                                <select class="form-control" name="to_year"  placeholder="to" required=""  >
