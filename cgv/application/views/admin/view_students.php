            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                <i class="material-icons">assignment</i> The following are the list of all Students.
                                <a class="pull-right" href="<?php echo base_url(); ?>admin/print_all_student" target="__blank">
        ...
        $.ajax({
            ...
            var total = 0,
              ...
              for(var i=0; i < response.length; i++){
                total += parseInt(response[i].units);

              }
              unit = total > 1 ? 'units' : 'unit';
              $('#unit_num').html(total);
              $('.badge').html(unit);
            }
        });
