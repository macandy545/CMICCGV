            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        ...
                        <h2>
                            <i class="material-icons">description</i> Semi-Finals Dean's List for S.Y. <b><?php echo $school_year;?>, <?php echo $sem;?></b> . 
                            <a class="pull-right" href="<?php echo base_url(); ?>admin/print_search_sfinal_dl/<?php echo $sem; ?>/<?php echo $school_year; ?>" target="__blank">
                    ...
                    <div id="" class="body">
                        <div class="row">
                            <?php foreach($search_sfinal_dlist as $key){ 
                                $no_of_subject = 0;
                                $sfinal_grade = 0;
