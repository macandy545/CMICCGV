 ...
 <body>
    <img style="float:right; margin-top:-1.5%;position:absolute;" src="<?php  echo base_url();?>webroot/images/cmic1.png" height="130" width="140"/>
 	<div class="col-md-12">
        ...
        <h4>PRELIM DEAN'S LIST</h4>
        <p><?php echo $this->session->userdata('curr_sem'); ?>, <?php echo $this->session->userdata('curr_sy'); ?></p>
       </center>
 		<!-- <center><h4>Prelim Dean's List's <?php echo $this->session->userdata('curr_sy');?> <?php echo $this->session->userdata('curr_sem');?></h4></center> -->
 					...
 					<tbody>
                        ...
                        <tr>
                            <?php if($final_prelim_grade <= 1.74){ ?>
                                ...
                                <td><?php echo substr($final_prelim_grade, 0, 4); ?></td>
                            <?php } } ?>
                        </tr>
 					</tbody>
 				</table>
