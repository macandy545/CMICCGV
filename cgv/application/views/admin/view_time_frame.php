                            ...
                            <ul class="header-dropdown m-r--5">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        ...
                                        <li><a href="<?php echo base_url(); ?>admin/disable_all_frames" class=" waves-effect waves-block" onclick="return confirm('This will disable all time frames. Continue?');">Disable all Time Frames</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php foreach($view_time_frame as $view){ ?>
                                          <tr>
                                                ...
                                                <div class="modal fade" id="tf<?php echo $view['tf_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="display: none;">
                                                      <div class="modal-dialog">
                                                        <div class="modal-content modal-lg">
                                                          ...
                                                          <?php echo form_open("admin/update_time_frame/".$view['tf_id']); ?>
                                                            <div class="col-md-12">
                        ...
                        <div class="modal fade" id="customFrames" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="display: none;">
                          <div class="modal-dialog">
                            <div class="modal-content modal-lg">
                              ...
                              <div class="modal-body">
                              <form method="post" action="<?php echo base_url(); ?>admin/enable_custom_frames">
                                <div class="col-md-12">
                                  <div class="panel-body">
                                    <div class="row">
                                      <div class="">
                                        <div class="col-md-12 text-center">
                                            <div class="demo-checkbox">
                                                <input type="checkbox" id="md_checkbox_1" class="chk-col-purple" name="term[]" value="PRELIM">
                                                <label for="md_checkbox_1">PRELIM</label>
                                                <input type="checkbox" id="md_checkbox_2" class="chk-col-purple" name="term[]" value="MIDTERM">
                                                <label for="md_checkbox_2">MIDTERM</label>
                                                <input type="checkbox" id="md_checkbox_3" class="chk-col-purple" name="term[]" value="SEMI-FINAL">
                                                <label for="md_checkbox_3">SEMI-FINAL</label>
                                                <input type="checkbox" id="md_checkbox_4" class="chk-col-purple" name="term[]" value="FINAL">
                                                <label for="md_checkbox_4">FINAL</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                          <label for="sub_name">From</label>
                        ...
                        <div class="modal fade" id="enableFrame" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="display: none;">
                          <div class="modal-dialog">
                            <div class="modal-content modal-lg">
                              ...
                              <div class="modal-body">
                              <form method="post" action="<?php echo base_url(); ?>admin/enable_all_frames">
                                <div class="col-md-12">
                                  <div class="panel-body">
                                    <div class="row">
                                      <div class="">
                                        <div class="col-md-12 text-center">
                                            <div class="demo-checkbox">
                                                <input type="checkbox" id="md_checkbox_1" class="chk-col-purple" value="PRELIM" checked="" disabled="">
                                                <label for="md_checkbox_1">PRELIM</label>
                                                <input type="checkbox" id="md_checkbox_2" class="chk-col-purple" value="MIDTERM" checked="" disabled="">
                                                <label for="md_checkbox_2">MIDTERM</label>
                                                <input type="checkbox" id="md_checkbox_3" class="chk-col-purple" value="SEMI-FINAL" checked="" disabled="">
                                                <label for="md_checkbox_3">SEMI-FINAL</label>
                                                <input type="checkbox" id="md_checkbox_4" class="chk-col-purple" value="FINAL" checked="" disabled="">
                                                <label for="md_checkbox_4">FINAL</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                    ...
                    <div class="card collapse" id="collapseExample">
                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                <li role="presentation" class="active"><a href="#home" data-toggle="tab" aria-expanded="true">Prelim</a></li>
                                <li role="presentation" class=""><a href="#profile" data-toggle="tab" aria-expanded="false">MidTerm</a></li>
                                <li role="presentation" class=""><a href="#messages" data-toggle="tab" aria-expanded="false">Semi-Final</a></li>
                                <li role="presentation" class=""><a href="#settings" data-toggle="tab" aria-expanded="false">Final</a></li>
                            </ul>
                                    ...
                                    <p>
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                                ...
                                                <tbody>
                                                    <?php foreach($late_prelim_grades as $late){ extract($late); ?>
                                    ...
                                    <p>
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                                ...
                                                <tbody>
                                                    <?php foreach($late_midterm_grades as $late){ extract($late); ?>
                                                        <tr class="text-center">
                                                            <td><label class="label label-primary"><?php echo $sub_name; ?></label></td>
                                                            <td><?php echo $lname.', '.$fname; ?></td>
                                                            <td><?php echo $sy; ?></td>
                                    ...
                                    <p>
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                                ...
                                                <tbody>
                                                    <?php foreach($late_semi_final_grades as $late){ extract($late); ?>
                                                        <tr class="text-center">
                                                            <td><label class="label label-primary"><?php echo $sub_name; ?></label></td>
                                                            <td><?php echo $lname.', '.$fname; ?></td>
                                                            <td><?php echo $sy; ?></td>
                                    ...
                                    <p>
                                       <div class="table-responsive">
                                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                                ...
                                                <tbody>
                                                    <?php foreach($late_final_grades as $late){ extract($late); ?>
                                                        <tr class="text-center">
                                                            <td><label class="label label-primary"><?php echo $sub_name; ?></label></td>
                                                            <td><?php echo $lname.', '.$fname; ?></td>
                                                            <td><?php echo $sy; ?></td>
