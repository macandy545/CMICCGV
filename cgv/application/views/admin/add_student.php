<body class="theme-cyan">
                        ...
                        <div class="body">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>admin/student_validation" method="post" accept-charset="utf-8">
                                            <div class="row">
                                                    ...
                                                    <div class="panel panel-default panel-fill">
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="">
                                                                ...
                                                                <div id="units_field" class="col-md-3">
                                                                    <label for="course">Course*</label>
                                                                    <select id="total_units" class="form-control" name="course">
                                                                ...
                                                                <!-- <div id="units_field" class="col-md-3">
                                                                    <label for="total_units">Total Units Taken*</label>
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" id="total_units" placeholder="Total Units" name="total_units" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));">
                                                                    </div>
                                                                    <span class="help-block"><small>Ex. 3</small></span>
                                                                </div> -->
                                                                <div class="col-md-1"></div>
                                                            </div>
                                                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#year').change(function(){
                var val = $(this).val();
                if(val=='1st Year' || val=='2nd Year' || val=='3rd Year' || val=='4th Year'){
                    $('#units_field').show();
                    $('#total_units').attr('required', 'required');
                }else{
                    $('#units_field').hide();
