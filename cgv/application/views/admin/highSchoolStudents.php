    ...
    <section class="content">
        <div class="container-fluid">
          <button onclick="history.back()" class="btn bg-cyan btn-circle waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Go Back"><i class="material-icons">arrow_back</i></button> Go Back To Previous Page
            ...
            <input type="hidden" name="dept" value="High School">
            <div class="pull-left">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <i class="material-icons">assignment</i> The following are list of Current <b>High School</b> Students as of S.Y. <b><?php echo $this->session->userdata('curr_sy');?></b>.
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    <thead>
                                        ...
                                        <?php } ?>
                                    <tbody>
                                        <?php foreach($highSchoolStudents as $view){ ?>
                                        <tr>
