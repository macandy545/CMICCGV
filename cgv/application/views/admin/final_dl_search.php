...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <center>
                <div class="container-fluid">
                    <form method="POST" action="<?php echo base_url(); ?>admin/search_final_dlist">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        ...
                        <h2>
                            <i class="material-icons">description</i> Finals Dean's List for S.Y. <b><?php echo $school_year;?>, <?php echo $sem;?></b> . 
                            <a class="pull-right" href="<?php echo base_url(); ?>admin/print_search_final_dl/<?php echo $sem; ?>/<?php echo $school_year; ?>" target="__blank">
                    ...
                    <div id="" class="body">
                        <div class="row">
                            <?php foreach($search_final_dlist as $key){ 
                                $no_of_subject = 0;
                                $final_grade = 0;
