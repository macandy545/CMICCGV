            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                <i class="material-icons">assignment</i> The following are the list of all Teachers. 
                                <a class="pull-right" href="<?php echo base_url(); ?>admin/print_all_teachers" target="__blank">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    <thead>
                                        ...
                                        <?php } ?>
                                    <tbody>
                                        <?php foreach($view_teacher as $view){ extract($view); ?>
                                        <tr>
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                          <li><a href="javascript:void(0);"><?php echo $teacher_pass; ?></a></li>
                                                    </ul>
                                                </div>
                                            </td>
