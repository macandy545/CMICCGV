            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                <i class="material-icons">assignment</i> The following are the list of Current Teachers as of S.Y.<b><?php echo $this->session->userdata('curr_sy');?>, <?php echo $this->session->userdata('curr_sem');?></b>. 
                                <a class="pull-right" href="<?php echo base_url(); ?>admin/print_all_current_teachers" target="__blank">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                          <?php echo $view['teacher_id']; ?> <span class="caret"></span>
                                                    </button>
                                                    <ul class="dropdown-menu">
                                                          <li><a href="javascript:void(0);"><?php echo $view['teacher_pass']; ?></a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                            <td><center><span class="table_image"><img src="<?php echo base_url(); ?>webroot/images/<?php echo $view['teacher_image']; ?>" class="img-circle img-thumbnail" alt="profile-image" id="img"></span></center></td>
                                            ...
                                            <td class="text-center">
                                                <a href='<?php echo base_url(); ?>admin/update_teacher/<?php echo $view['teacher_id']; ?>#' data-placement="top" title="Update Teacher" data-toggle="tooltip">
                                                    <button type="button" class="btn btn-warning btn-xs"><i class="material-icons">create</i></button>
                                                </a>
                                                <a  href='<?php echo base_url(); ?>admin/delete_teacher/<?php echo $view['teacher_id']; ?>' data-placement="top" title="Delete Teacher" data-toggle="tooltip">
                                                    <button type="button" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete this Teacher?')"><i class="material-icons">delete_sweep</i></button>
                                                </a>
                                                <a href='<?php echo base_url(); ?>admin/view_teacher_subjects/<?php echo $view['teacher_id']; ?>/<?php echo $view['fname']; ?>' data-placement="top" title="View Teacher's Subjects" data-toggle="tooltip">
