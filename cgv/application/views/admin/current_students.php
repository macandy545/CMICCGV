    ...
    <section class="content">
        <div class="container-fluid">
          <button onclick="history.back()" class="btn bg-cyan btn-circle waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Go Back"><i class="material-icons">arrow_back</i></button> Go Back To Previous Page
            <form method="POST" action="<?php echo base_url(); ?>admin/search_college_student">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <!-- <button onclick="history.back()" class="btn bg-cyan btn-circle waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Go Back"><i class="material-icons">arrow_back</i></button>Go Back To Previous Page -->
                    <!-- <div class="pull-right">
                      <form method="GET" action="<?php echo base_url(); ?>admin/search_college_student">
                      <button type="submit" class="btn bg-cyan waves-effect">
                            <i class="material-icons">search</i>
                        </button>
                      <a href="<?php echo base_url(); ?>admin/add_student">
                    ...
                    <div class="col-md-3 pull-right">
                      <select class="form-control show-tick" name="school_year">
                          <option>Search College Students By S.Y.</option>
                        <?php foreach($school_years as $view){ extract($view);?>
                            <option value="<?php echo $sy ?>"><?php echo $sy ?></option>
                        <?php }?>
                      </select>
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                <i class="material-icons">assignment</i> The following are list of Current <b>College</b> Students as of S.Y. <b><?php echo $this->session->userdata('curr_sy');?>, <?php echo $this->session->userdata('curr_sem');?></b>.
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    <thead>
                                        ...
                                        <?php } ?>
                                    <tbody>
                                        <?php foreach($view_current_students as $view){ ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <!-- <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#defaultModal<?php echo $view['stud_id']; ?>"><i class="material-icons">email</i></button> -->
                                            </td>
                                        </tr>
                                        <?php }  ?>
                                    </tbody>
          ...
          <div class="modal-body">
            <div class="col-md-12">
              ...
              <div class="col-md-6">
                ...
                <input type="text" name="username" value="<?php echo $api['username']; ?>" class="form-control">
                <br/>
                <label>Hash:</label>
                <input type="text" name="hash" value="<?php echo $api['hash']; ?>" class="form-control">
                <br/>
                <label>Sender:</label>
                <input type="text" name="sender" value="<?php echo $api['sender']; ?>" class="form-control">
                <br/>
                <label>Send to:</label>
              ...
              <div class="col-md-6">
                <label>Message:</label>
                <textarea style="width: 271px;height: 267px;"></textarea>
              </div>
              <?php } ?>
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-info waves-effect"><i class="material-icons">email</i> SEND</button>
